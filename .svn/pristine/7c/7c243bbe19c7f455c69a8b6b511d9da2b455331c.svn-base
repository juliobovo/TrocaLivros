...
<html>
 ...
 ?>
        ...
        <div id="tabela_livros">
           ...
           <?php 
                $result=  mysql_query("SELECT * FROM livro "
                        . "WHERE id not in (SELECT id_livro FROM livrotenho "
           ...
           <?php while($linha = mysql_fetch_array($result)){?>
                                <tr>
                                    ...
                                    <td><a id="texto_tabela" href=filesystem/adicionartenho.php?id=<?php echo $linha['id'];?>> Adcionar</a></td> <!– passando o valor do id para a página editar1.php –>
